...
//                .maxBy(2);
    ...
    public static class sumTips extends ProcessWindowFunction<
    ...
    private static class reduceMaxTip implements ReduceFunction<Tuple3<Long, Long, Float>> {
        public Tuple3<Long, Long, Float> reduce(Tuple3<Long, Long, Float> r1, Tuple3<Long, Long, Float> r2) {
            return (Float)r1.getField(2) > (Float)r2.getField(2) ? r1 : r2;
        }
    }
